...
from models.reservoir_model88m import Reservoir
...
class model():
    ...
    def draw_FHN(self,preds,preds2,preds3,start2,start3,steps,nj):    
        ...
        #ax1.plot(X[Nj,nj,start2-d:start2+steps+d,0],X[Nj,nj,start2-d:start2+steps+d,1],'ko-',markersize=10,label='True')
        ax1.plot(X[Nj,nj,start3-d:start3+steps+d,0],X[Nj,nj,start3-d:start3+steps+d,1],'k^-',markersize=13,label='True',linewidth=3)

        #ax1.plot(preds2[Nj,nj,:steps,0],preds2[Nj,nj,:steps,1],'ro--',markersize=5,label='Multi-step interpolation prediction')
        ax1.plot(preds3[Nj,nj,:steps,0],preds3[Nj,nj,:steps,1],'ro--',markersize=5,label='Multi-step extrapolation prediction') 
        
        ax1.tick_params(labelsize=30)
        ax1.set_xlabel('x',size=40)
        ax1.set_ylabel('y',size=40)
    ...
    def draw_3d(self,preds,preds2,preds3,start2,start3,steps,nj):    
        ...
        ax1.plot(X[Nj,nj,start3-d:start3+steps+d,0],X[Nj,nj,start3-d:start3+steps+d,1],
                 X[Nj,nj,start3-d:start3+steps+d,2],'k^-',markersize=13,label='True',linewidth=3)
        ...
        ax1.plot(preds3[Nj,nj,:steps,0],preds3[Nj,nj,:steps,1],preds3[Nj,nj,:steps,2],
                 'ro--',markersize=5,label='Multi-step extrapolation prediction')
